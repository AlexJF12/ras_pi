...
command_line_code = "cd ~/Pictures/every_five_min ; ffmpeg -framerate 10 -f image2 -pattern_type glob -i 'pic_" + date_for_vid + "-*.jpg' ~/Documents/daily_vids/" + date_for_vid + "_vid.mp4"
