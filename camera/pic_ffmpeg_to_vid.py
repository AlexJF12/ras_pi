...
command_line_code = "ffmpeg -framerate 10 -f image2 -pattern_type glob -i '~/Pictures/every_five_min/pic_" + date_for_vid + "-*.jpg' ~/Documents/daily_vids/" + date_for_vid + "}.mp4"
